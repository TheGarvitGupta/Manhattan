...
kStravaListAthleteActivitiesURL = "https://www.strava.com/api/v3/athlete/activities"
kStravaGetActivityRequestURL = "https://www.strava.com/api/v3/activities"
...
kStravaFetchMinimumDelay = 6 * hours
kStravaDetailedActivityFetchMinimumDelay = 5 * seconds